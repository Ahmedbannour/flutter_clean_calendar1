    ...
    if (!widget.hideArrows) {
      leftArrow = InkWell(
        ...
        child: Padding(
                ...
                child: Icon(Icons.chevron_left , color: Color(0xff333333),),
        ),
      );
      rightArrow = InkWell(
            ...
            //     todayIcon ?? Container(),
                Container(
                  child : Row(
                    ...
                    children: [
                      Text(
                        '${DateFormat('MMM').format(DateTime(_selectedDate.year, _selectedDate.month-1, _selectedDate.day))}',
                        style: TextStyle(
                            fontFamily: 'OpenSansBold',
                            fontSize: 17.0,
                      ...
                      SizedBox(width: 50,),
                      Text(
                        '${DateFormat('MMM').format(DateTime(_selectedDate.year, _selectedDate.month, _selectedDate.day))}',
                        style: TextStyle(
                            fontFamily: 'OpenSansBold',
                            fontSize: 17.0,
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                child: isExpanded
                    ? Padding(
                            padding: EdgeInsets.all(8),
                            child: Icon(Icons.keyboard_arrow_up , color: Color(0xff333333),),
                          )
                    : Padding(
                            padding: EdgeInsets.all(8),
                            child: Icon(Icons.keyboard_arrow_down , color: Color(0xff333333),),
                          )
                  ),
            ],
          ),
      ...
      return Expanded(
                  ...
                  return AnimationLimiter(
                    child: AnimationConfiguration.staggeredList(
                      ...
                      child:  FadeInAnimation(
                          ...
                          curve: Curves.linear,
                          child:Container(
                            height: (event.description != '' && event.description != null) ? 150 : 120,
        ...
        Column(
              ...
              children : [
                Container(
                  child: Lottie.asset(
                    'assets/images/lottieCalendar.json',
                    width: 300,
                    height: 120 ,
                ...
                Container(
                  width: 300 ,
                  child: Text(
                      '${widget.errorMsg[0].toUpperCase()}${widget.errorMsg.substring(1).toLowerCase()}',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'OpenSansBold',
                        fontSize: 20,
